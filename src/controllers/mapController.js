...
import {serviceController, tableController, layerController} from "@/controllers";
...
const functions = {
    ...
    deleteService(service) {
        ...
        let activeDynamicLayersColors = getters.getActiveDynamicLayersColorsGetter()
        let letsGetFirstIndexOfLayer = activeDynamicLayersColors.indexOf(service.id);
        activeDynamicLayersColors[letsGetFirstIndexOfLayer] = service.id;
        setters.setColorsArray(activeDynamicLayersColors);
                ...
                if (serviceHelper.isLocalService(service)) {
                    layer = new VectorTileLayer({
                        ...
                        style: (feature) => {
                            ...
                            // console.log(layerController.getSelectedLayers())
                            // console.log(feature.get("layerId"))
                            let activeDynamicLayersColors = getters.getActiveDynamicLayersColorsGetter();
                            let letsGetFirstZero = 0
                            console.log(activeDynamicLayersColors.indexOf(service.id))
                            if (activeDynamicLayersColors.indexOf(service.id) == -1) {
                                letsGetFirstZero = activeDynamicLayersColors.indexOf(0);

                                activeDynamicLayersColors[letsGetFirstZero] = service.id;
                                setters.setColorsArray(activeDynamicLayersColors);
                                console.log(activeDynamicLayersColors);


                            } else {
                                letsGetFirstZero = activeDynamicLayersColors.indexOf(service.id);

                                activeDynamicLayersColors[letsGetFirstZero] = service.id;
                                setters.setColorsArray(activeDynamicLayersColors);
                                console.log(activeDynamicLayersColors);
                            }
                            var color = materialColors[letsGetFirstZero];
