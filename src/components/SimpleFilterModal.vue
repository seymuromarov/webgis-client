<template>
    ...
    >
            ...
            <div class="form-group col-md-12">
                ...
                <div class="row">
                    <div class="btn-group btn-group-toggle col-md-12" data-toggle="buttons">
                        <multiselect
                            v-model="cropMap2019value"
                            :options="cropMap2019Options"
                            :multiple="true"
        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-align: center">{{reportResult}}</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-check">
                    <input
                        ...
                        aria-label
                    />
                    <label class="form-check-label" for="isIncludeBBOX">Include Last Selected BBOX?</label>
                </div>
            </div>
            <div class="col-md-12">
                ...
                <button class="btn btn-outline-info filterApplyButton" @click="applyFilter">Apply</button>
            </div>
        </div>
    </modal>
        ...
        async applyFilter() {
            if (this.cropArithmeticOperation !== "unset") {
                ...
                this.query.outStatistics =
                    ...
                    '", "onStatisticField": "Shape_Area", "outStatisticFieldName":' +
                    '"' +
                    this.outStatisticFieldName +
                    '"}]';
            } else {
                this.query.outStatistics = "";
            }
