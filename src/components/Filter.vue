            ...
            <div class="filterActionsDiv">
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <button @click="$emit('appendFilterQuery', '= ')"
                        ...
                        <tr>
                            ...
                            <td>
                                <button @click="$emit('appendFilterQuery', 'LIKE ')"
                                        class="parameterButton btn btn-sm btn-outline-secondary">
                                    like
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <button @click="$emit('appendFilterQuery', 'AND ')"
                                        class="parameterButton btn btn-sm btn-outline-secondary">
                                    and
                                </button>
                            </td>
                            <td>
                                <button @click="$emit('appendFilterQuery', 'OR ')"
                                        class="parameterButton btn btn-sm btn-outline-secondary">
                                    or
                                </button>
                            </td>
                        ...
                        <tr>
                            <td>
                                <button @click="$emit('appendFilterQuery', 'IS NULL')"
                                        class="parameterButton btn btn-sm btn-outline-secondary">
                                    null
                                </button>
                            </td>
