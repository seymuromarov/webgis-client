...
class MapHelper {
    ...
    historyNext() {
        if (
            this.data.historyEventsIndex + 1 ===
            this.data.historyEvents.length
        ) {
                ...
                listener = self.data.sketch
                    ...
                    .on("change", function(evt) {
                        ...
                        try {
                            ...
                            self.data.measuremaptooltip.setPosition(
                                maptooltipCoord
                            );
                        } catch (e) {
            ...
            function(e) {
                try {
                    self.data.measuremaptooltipElement.className =
                        "maptooltip maptooltip-static " +
                        self.data.featureIDSet;
                ...
                let newStyle = new Style({
                    fill: new Fill({ color: "var(--transparent)" }),
