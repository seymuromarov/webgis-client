class ColorPicker {
    ...
    renderColor(subLayer , fillColor , borderColor) {
        ...
        let layerDyn = '{"id":' +subLayer + ',"name":"","source":{"type":"mapLayer","mapLayerId": ' +subLayer + '},"drawingInfo":{"renderer":{"type":"simple","label":"","description":"","symbol":{"color":' + color + ',"outline":{"color":' + outline + ',"width":1.0,"type":"esriSLS","style":"esriSLSSolid"},"type":"esriSFS","style":"esriSFSSolid"}}},"minScale":0,"maxScale":0},';
        return layerDyn;
